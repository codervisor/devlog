...
describe.skipIf(!runIntegrationTests)('Hierarchy API Integration Tests', () => {
  ...
  describe('Project Events Filtering', () => {
    ...
    it('should filter events by timestamp range', async () => {
      ...
      const result = await client.get(`/projects/${testProjectId}/events?from=${from}&to=${to}`);
    ...
    it('should filter events by event type', async () => {
      ...
      const result = await client.get(`/projects/${testProjectId}/events?eventType=llm_request`);
    ...
    it('should filter events by severity', async () => {
      ...
      const result = await client.get(`/projects/${testProjectId}/events?severity=error`);
    ...
    it('should respect limit parameter', async () => {
      ...
      const result = await client.get(`/projects/${testProjectId}/events?limit=10`);
    ...
    it('should reject invalid severity', async () => {
      ...
      const result = await client.get(`/projects/${testProjectId}/events?severity=invalid`, 400);
    ...
    it('should reject invalid date format', async () => {
      ...
      const result = await client.get(`/projects/${testProjectId}/events?from=invalid-date`, 400);
