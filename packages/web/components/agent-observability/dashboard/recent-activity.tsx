        ...
        <CardContent>
          <div className="flex flex-col items-center justify-center py-12 text-center">
            ...
            <p className="text-sm text-muted-foreground max-w-md">
              Start monitoring your AI coding agents by configuring collectors and starting agent
              sessions. Visit the Settings page to set up your first collector.
            </p>
          </div>
        </CardContent>
      </Card>
            ...
            <div key={event.id} className="flex items-start space-x-4 p-3 rounded-lg border">
              ...
              <div className="flex-1 space-y-1">
                ...
                {event.context?.filePath && (
                  <p className="text-xs text-muted-foreground">{event.context.filePath}</p>
                )}
              </div>
            </div>
          ))}
