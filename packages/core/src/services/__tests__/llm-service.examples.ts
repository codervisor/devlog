    ...
    const request: LLMCompletionRequest = {
      messages: [
        ...
        },
        {
          role: 'user',
          content:
            'What are the benefits of using TypeScript over JavaScript for large applications?',
        },
      ],
      model: modelConfig,
    };
      ...
      messages: [
        {
          role: 'user',
          content:
            'Write a short story about a developer who discovers an AI that helps with coding.',
        },
      ],
      model: modelConfig,
    };
