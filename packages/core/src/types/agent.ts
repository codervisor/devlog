...
/**
 * Time bucket interval for aggregations
 *
 * Used with TimescaleDB time_bucket function for efficient time-series aggregations.
 *
 * @example
 * ```typescript
 * const interval: TimeBucketInterval = '1 hour';
 * ```
 */
...
/**
 * Time-series aggregation result for events
 *
 * Returned by TimescaleDB time_bucket aggregations for dashboard analytics.
 *
 * @example
 * ```typescript
 * const stats: EventTimeBucketStats = {
 *   bucket: new Date('2025-11-02T12:00:00Z'),
 *   projectId: 1,
 *   agentId: 'github-copilot',
...
export interface EventTimeBucketStats {
  /** Time bucket timestamp (start of the bucket period) */
  bucket: Date;
  /** Project identifier */
  projectId: number;
  /** Agent identifier */
  ...
  totalTokens?: number;
  /** Average prompt tokens per event */
  avgPromptTokens?: number;
  /** Average response tokens per event */
...
/**
 * Daily aggregation result for sessions
 *
 * Pre-computed daily statistics from continuous aggregates.
 *
 * @example
 * ```typescript
 * const stats: SessionDailyStats = {
 *   bucket: new Date('2025-11-02T00:00:00Z'),
 *   projectId: 1,
 *   agentId: 'github-copilot',
 *   sessionCount: 25,
 *   avgDuration: 3600,
...
export interface SessionDailyStats {
  /** Day bucket timestamp (midnight UTC) */
  bucket: Date;
  /** Project identifier */
  projectId: number;
  /** Agent identifier */
...
/**
 * Parameters for time-bucket aggregation queries
 *
 * @example
 * ```typescript
